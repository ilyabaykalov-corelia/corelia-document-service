...
@Component
public final class KidOpsDocumentPolicy implements DocumentPolicy {
    private final ServiceClient services;
    public KidOpsDocumentPolicy(ServiceClient services) { this.services = services; }
    public String type() { return KidOps.TYPE; }
    public int schemaVersion() { return 1; }
    public JsonNode validate(JsonNode attributes) { return KidOps.validate(attributes, true); }
